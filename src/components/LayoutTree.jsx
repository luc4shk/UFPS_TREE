    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-150 p-4">
            ...
            <div className="flex items-center mb-4 w-full max-w-5xl px-4">
                ...
                <button className={"mr-4 p-2 bg-white-500"} style={{ color: linkColor }}>
            ...
            {/* Contenedor */}
            <div className= {`p-4 rounded-lg flex flex-col md:flex-row gap-4 w-full max-w-5xl h-auto md:h-[80vh]`} style={{ backgroundColor: containerColor }}>
